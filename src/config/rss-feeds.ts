...
export const RSS_FEEDS: RssFeed[] = [
  ...
  { id: "reliefweb", name: "ReliefWeb", url: "https://reliefweb.int/updates/rss.xml", categoryHint: "disasters", authority: "official" },
  { id: "nws", name: "US National Weather Service", url: "https://www.weather.gov/rss_page.php?site_name=nws", categoryHint: "disasters", authority: "official" },
  ...
  { id: "nasa-climate", name: "NASA Climate", url: "https://climate.nasa.gov/news/rss.xml", categoryHint: "climate-environment", authority: "official" },
  { id: "noaa-news", name: "NOAA News", url: "https://www.noaa.gov/news/feed", categoryHint: "climate-environment", authority: "official" },
  ...
  { id: "imf-news", name: "IMF News", url: "https://www.imf.org/en/News/RSS", categoryHint: "economy", authority: "official" },
  { id: "cnbc", name: "CNBC", url: "https://www.cnbc.com/id/100003114/device/rss/rss.html", categoryHint: "economy", authority: "established" },
  { id: "oecd", name: "OECD Newsroom", url: "https://www.oecd.org/newsroom/rss.xml", categoryHint: "economy", authority: "official" },

  { id: "iaea", name: "IAEA", url: "https://www.iaea.org/feeds/topnews", categoryHint: "energy", authority: "official" },
  ...
  { id: "iea", name: "International Energy Agency", url: "https://www.iea.org/rss/news.xml", categoryHint: "energy", authority: "official" },

  { id: "freightwaves", name: "FreightWaves", url: "https://www.freightwaves.com/feed", categoryHint: "supply-chains", authority: "specialist" },
  { id: "maritime-executive", name: "The Maritime Executive", url: "https://maritime-executive.com/rss", categoryHint: "supply-chains", authority: "specialist" },
  ...
  { id: "ecdc", name: "ECDC", url: "https://www.ecdc.europa.eu/en/news-events/rss", categoryHint: "health", authority: "official" },
  { id: "nih", name: "US NIH", url: "https://www.nih.gov/news-events/news-releases/rss.xml", categoryHint: "health", authority: "official" },
