...
export const RSS_FEEDS: RssFeed[] = [
  ...
  { id: "france24", name: "DW News", url: "https://rss.dw.com/rdf/rss-en-all", categoryHint: "politics-diplomacy", authority: "established" },
  ...
  { id: "reliefweb", name: "NASA Breaking News", url: "https://www.nasa.gov/rss/dyn/breaking_news.rss", categoryHint: "disasters", authority: "official" },
  ...
  { id: "nasa-climate", name: "NASA Earth", url: "https://www.nasa.gov/earth/feed/", categoryHint: "climate-environment", authority: "official" },
  { id: "noaa-news", name: "ScienceDaily Earth & Climate", url: "https://www.sciencedaily.com/rss/earth_climate.xml", categoryHint: "climate-environment", authority: "established" },
  ...
  { id: "imf-news", name: "NPR Economy", url: "https://feeds.npr.org/1017/rss.xml", categoryHint: "economy", authority: "established" },
  { id: "cnbc", name: "CNBC", url: "https://www.cnbc.com/id/100003114/device/rss/rss.html", categoryHint: "economy", authority: "established" },
  { id: "oecd", name: "NPR Business", url: "https://feeds.npr.org/1006/rss.xml", categoryHint: "economy", authority: "established" },
  ...
  { id: "iea", name: "Rigzone", url: "https://www.rigzone.com/news/rss/rigzone_latest.aspx", categoryHint: "energy", authority: "specialist" },

  { id: "freightwaves", name: "FreightWaves", url: "https://www.freightwaves.com/feed", categoryHint: "supply-chains", authority: "specialist" },
  { id: "maritime-executive", name: "MarineLink", url: "https://www.marinelink.com/news/rss", categoryHint: "supply-chains", authority: "specialist" },
  ...
  { id: "ecdc", name: "NPR Health", url: "https://feeds.npr.org/1128/rss.xml", categoryHint: "health", authority: "established" },
  { id: "nih", name: "STAT Health", url: "https://www.statnews.com/feed/", categoryHint: "health", authority: "established" },
